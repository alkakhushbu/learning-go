...
func (h *Handler) CreateTask(c *gin.Context) {
	...
	//make call to print micro task api with gin.Context as parameter
	CallPrintMicroService(c)
	if err != nil {
		span.SetAttributes(semconv.HTTPResponseStatusCodeKey.Int(http.StatusCreated))
	}
